...
SPECIAL_VDEVS="$(ls /dev/disk/by-id | grep 'nvme-eui.00000000000000008ce38ee2' | grep -v part | grep -ve '_1$' | tr '\n' ' ')"
...
# HLF1016437G00LV - remove
# HLF1016437G00UM - remove
# HLF1016437G00UL
# HLF1016437G00LR
mk_individual_raidz_pools(){
	...
	zpool create "${HOSTNAME}-01" ${ZPOOL_PROPS} ${ZFS_PROPS}\
		raidz2 $RAIDZ2_10_HLF1016437G00UL_VDEV_00\
		raidz2 $RAIDZ2_10_HLF1016437G00UL_VDEV_01\
		raidz2 $RAIDZ2_10_HLF1016437G00UL_VDEV_02\
		raidz2 $RAIDZ2_10_HLF1016437G00UL_VDEV_03\
		raidz2 $RAIDZ2_10_HLF1016437G00UL_VDEV_04\
		raidz2 $RAIDZ2_10_HLF1016437G00UL_VDEV_05\
		raidz2 $RAIDZ2_10_HLF1016437G00UL_VDEV_06\
		raidz2 $RAIDZ2_10_HLF1016437G00UL_VDEV_07\
		spare  $RAIDZ2_10_HLF1016437G00UL_SPARES
	zpool create "${HOSTNAME}-02" ${ZPOOL_PROPS} ${ZFS_PROPS}\
		raidz2 $RAIDZ2_10_HLF1016437G00LR_VDEV_00\
		raidz2 $RAIDZ2_10_HLF1016437G00LR_VDEV_01\
		raidz2 $RAIDZ2_10_HLF1016437G00LR_VDEV_02\
		raidz2 $RAIDZ2_10_HLF1016437G00LR_VDEV_03\
		raidz2 $RAIDZ2_10_HLF1016437G00LR_VDEV_04\
		raidz2 $RAIDZ2_10_HLF1016437G00LR_VDEV_05\
		raidz2 $RAIDZ2_10_HLF1016437G00LR_VDEV_06\
		raidz2 $RAIDZ2_10_HLF1016437G00LR_VDEV_07\
		spare  $RAIDZ2_10_HLF1016437G00LR_SPARES
}
#mk_4_5u84_raidz2
#mk_24_vdev_draid2_jbods
mk_individual_raidz_pools
